...
https://raw.githubusercontent.com/AtencionEsTodoNecesitas/oh-my-opencode/refs/heads/dev/docs/guide/installation.md
```
...
> ```bash
> curl -fsSL https://raw.githubusercontent.com/AtencionEsTodoNecesitas/oh-my-opencode/refs/heads/dev/docs/guide/installation.md
> ```
...
Verify the installation completed correctly, then inform the user that setup is complete and they can run `opencode` to start using it.
