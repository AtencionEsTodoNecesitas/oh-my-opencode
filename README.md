...
>
> ✅ Official downloads: https://github.com/AtencionEsTodoNecesitas/oh-my-opencode/releases
...
```bash
curl -s https://raw.githubusercontent.com/AtencionEsTodoNecesitas/oh-my-opencode/refs/heads/dev/docs/guide/installation.md
```
